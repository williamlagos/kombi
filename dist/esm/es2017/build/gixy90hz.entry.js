...
import { c as showOrderBids, d as selectMerchantForOrder } from './chunk-b29ff8f0.js';
import { a as close } from './chunk-fe10219c.js';
import { h as placeOrder } from './chunk-3c944ae9.js';

class PageOrderDetail {
    constructor() {
    ...
    static get style() { return "page-order-detail ion-card{text-align:center}page-order-detail img{max-width:140px;margin:0 auto 20px}page-order-detail p{color:#60646b}.outer-content{display:-ms-flexbox;display:flex;-ms-flex-align:center;align-items:center;-ms-flex-pack:center;justify-content:center}"; }
}

export { PageOrderDetail };

...
import { o as updateProfile } from './chunk-fe10219c.js';
import { j as debounce } from './chunk-e658e8b7.js';
import { a as attachComponent, i as detachComponent, f as transition } from './chunk-0844be35.js';
...
class RouterOutlet {
    ...
    async componentDidLoad() {
        this.gesture = (await import('./chunk-9d14d64c.js')).createSwipeBackGesture(this.el, this.queue, () => !!this.swipeHandler && this.swipeHandler.canStart(), () => this.swipeHandler && this.swipeHandler.onStart(), step => this.ani && this.ani.progressStep(step), (shouldComplete, step, dur) => {
            if (this.ani) {
...
export { PageAccount, Route as IonRoute, RouteRedirect as IonRouteRedirect, Router as IonRouter, RouterOutlet as IonRouterOutlet };

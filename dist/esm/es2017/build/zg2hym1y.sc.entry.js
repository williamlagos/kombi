...
class Uploader {
    ...
    static get style() { return ".image-upload.sc-image-uploader, image-uploader.sc-image-uploader{min-width:100%}.image-upload.sc-image-uploader{position:relative;display:-ms-flexbox;display:flex;-ms-flex-wrap:wrap;flex-wrap:wrap;margin:1em auto}.image-upload__edit.sc-image-uploader{position:absolute;top:-9px;right:-9px;z-index:1}.image-upload__edit.sc-image-uploader   input.sc-image-uploader, .image-upload__edit.sc-image-uploader   label.sc-image-uploader{width:34px;height:34px}.image-upload__edit.sc-image-uploader   label.sc-image-uploader{display:block;color:#fff;background:#000;border:1px solid transparent;border-radius:100%;-webkit-box-shadow:0 2px 4px 0 rgba(0,0,0,.12);box-shadow:0 2px 4px 0 rgba(0,0,0,.12);cursor:pointer;font-weight:400;-webkit-transition:all .2s ease-in-out;transition:all .2s ease-in-out;z-index:1}.image-upload__edit.sc-image-uploader   label.sc-image-uploader:hover{background:#fff;color:#000;border-color:#d6d6d6}label.sc-image-uploader:active{background:red}.image-upload__edit.sc-image-uploader   label.sc-image-uploader:after{content:\"✎\";position:absolute;top:10px;left:0;right:0;margin:auto;text-align:center}.image-upload__edit.sc-image-uploader   input.sc-image-uploader{position:absolute;left:0;top:0;right:0;bottom:0;opacity:0;width:0;height:100%}.image-upload__preview.sc-image-uploader{width:192px;height:192px;border-radius:100%;border:6px solid #f8f8f8;-webkit-box-shadow:0 2px 4px 0 rgba(0,0,0,.1);box-shadow:0 2px 4px 0 rgba(0,0,0,.1)}.image-upload__multiple-preview.sc-image-uploader{width:80px;height:80px;border-radius:8px;border:6px solid #fff;-webkit-box-shadow:0 2px 4px 0 rgba(0,0,0,.2);box-shadow:0 2px 4px 0 rgba(0,0,0,.2);margin:5px}.image-upload__multiple-preview.sc-image-uploader > div.sc-image-uploader, .image-upload__preview.sc-image-uploader > div.sc-image-uploader{height:100%;width:100%;background-size:cover;background-repeat:no-repeat;background-position:50%}#preview0.sc-image-uploader{background:url(assets/img/flatcube.svg);background-size:cover;background-repeat:no-repeat;background-position:50%}"; }
}

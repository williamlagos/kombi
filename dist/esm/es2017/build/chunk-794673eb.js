...
async function overlayAnimation(overlay, animationBuilder, baseEl, opts) {
    ...
    const animation = overlay.animation = await import('./chunk-d84dff50.js').then(mod => mod.create(animationBuilder, aniRoot, opts));
...
export { present as a, dismiss as b, eventMethod as c, createOverlay as d, dismissOverlay as e, getOverlay as f, BACKDROP as g, isCancel as h };

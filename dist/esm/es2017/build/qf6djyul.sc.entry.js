...
import { a as attachComponent, h as deepReady, i as detachComponent } from './chunk-0844be35.js';
...
class Popover {
    ...
    hostData() {
        return {
            ...
            class: Object.assign({}, getClassMap(this.cssClass), { [`${this.mode}`]: true, "popover-translucent": this.translucent })
        };
    }
    render() {
        return [

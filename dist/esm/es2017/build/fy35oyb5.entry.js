...
import { b as getClassMap } from './chunk-c82b670d.js';
import { g as BACKDROP, h as isCancel, a as present, b as dismiss, c as eventMethod } from './chunk-794673eb.js';
...
class Alert {
    ...
    hostData() {
        return {
            ...
            class: Object.assign({}, getClassMap(this.cssClass), { [`${this.mode}`]: true, "alert-translucent": this.translucent })
        };
    }
    renderAlertButtons() {
        ...
        return (h("div", { class: alertButtonGroupClass }, buttons.map(button => h("button", { type: "button", class: buttonClass(button), tabIndex: 0, onClick: () => this.buttonClick(button) }, h("span", { class: "alert-button-inner" }, button.text), this.mode === "md" && h("ion-ripple-effect", null)))));
    }
    render() {

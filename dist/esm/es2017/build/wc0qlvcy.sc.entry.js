...
import { c as createColorClasses, b as getClassMap } from './chunk-c82b670d.js';
import { a as present, b as dismiss, c as eventMethod, h as isCancel } from './chunk-794673eb.js';
...
class Toast {
    ...
    renderButtons(buttons, side) {
        ...
        return (h("div", { class: buttonGroupsClasses }, buttons.map(b => h("button", { type: "button", class: buttonClass(b), tabIndex: 0, onClick: () => this.buttonClick(b) }, h("div", { class: "toast-button-inner" }, b.icon &&
            h("ion-icon", { name: b.icon, slot: b.text === undefined ? "icon-only" : undefined, class: "toast-icon" }), b.text), this.mode === "md" && h("ion-ripple-effect", { type: b.icon !== undefined && b.text === undefined ? "unbounded" : "bounded" })))));
    }
    render() {

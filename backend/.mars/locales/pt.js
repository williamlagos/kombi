...
module.exports = {
    ...
    "meet_the_project": `Conheça a ${display_name}!`,
    "merchant": `Freteiro`,
    "merchants": `Freteiros`,
    ...
    <br>
    Para que você possa utilizar o Marketplace do ${display_name} destacamos algumas informações da contratação do serviço e outros temas relevantes para facilitar a sua experiência no nosso Site:<br>
    <br>
    A - O que é o Marketplace do ${display_name}? Marketplace nada mais é do que um grande local de compras e vendas de produtos. No ambiente online isso se traduz em um espaço virtual onde além de serem vendidos produtos e serviços pelo ${display_name}, a empresa permite que outros lojistas anunciem seus produtos e serviços através do endereço eletrônico ${website}. Assim, o ${display_name} é mais do que uma loja virtual, é como se fosse um shopping center virtual, onde vários lojistas vendem seus produtos e serviços diretamente aos consumidores. Podemos dizer então que o ${display_name} é uma plataforma online, integrada ao portal ${website}, onde um usuário Vendedor pode oferecer seus próprios produtos e/ou serviços diretamente a usuários Compradores. O serviço prestado pelo ${display_name} é o oferecimento desta plataforma aos usuários, com inúmeras funcionalidades, permitindo que usuários Vendedores e Compradores se aproximem e realizem transações diretamente entre si.<br>
    <br>
    B - Quem vende os produtos ou serviços do Marketplace? Ao acessar o endereço ${website} e buscar um produto e/ou serviço, o usuário Comprador terá várias ofertas relacionadas ao produto e/ou serviços que procura. Essas ofertas podem ser de produto vendido e entregue diretamente pelo ${display_name} ou vendido e entregue diretamente por um usuário Vendedor. Atenção: quando você, usuário Comprador, escolher um produto ou serviço oferecido diretamente por terceiros, usuários Vendedores, você estará sujeito às regras e condições de oferta disponibilizada por este usuário Vendedor. O ${display_name} não regula preço, prazo de entrega e condições da oferta, sendo estas feitas exclusivamente pelo usuário Vendedor. Desta forma, o usuário Comprador está ciente e de acordo que, ao comprar um produto e/ou serviço diretamente de um usuário Vendedor, o ${display_name} não será responsável pelo conteúdo, prazo de entrega e condições da oferta do usuário Vendedor. O ${display_name} somente se responsabiliza pelo seu próprio conteúdo e pelas suas ofertas.<br>
    <br>
    C - Como identifico um produto ou serviço oferecido no Marketplace do ${display_name}? Em cada oferta do Site é exibida informação sobre quem vende e entrega o produto ou serviço. Antes de adicionar um produto ou serviço no seu carrinho, verifique no campo "Vendido e entregue por" se quem o oferece é um usuário Vendedor ou o ${display_name}. Abaixo, exemplo de como você visualizará as opções de compra:<br>
    <br>
    ...
    <br>
    E - A quem se aplicam as condições dos Termos e Condições de Uso do Marketplace? Estes Termos e Condições de Uso do Marketplace se aplicam a todos os usuários do Site Vendedores ou Compradores. Ao utilizar o Marketplace do ${display_name} o usuário declara que leu, compreendeu e aceitou estes Termos e Condições de Uso do Marketplace, os Termos e Condições Gerais de Uso do site, a Política de Privacidade do ${display_name} e as demais políticas do site.<br>
    <br>
    F - Como esclareço minhas dúvidas sobre o Marketplace do ${display_name}? Qualquer dúvida sobre o Marketplace do ${display_name} pode ser esclarecida entrando em contato com nosso Atendimento, por email, chat ou telefone.<br>
    <br>
    Termos e Condições de Uso do Marketplace - Contrato do Usuário<br>
    Estes Termos e Condições de Uso do Marketplace (ou Contrato) aplicam-se aos usuários Vendedores e Compradores dos serviços oferecidos pela ${display_name} por meio do Site www.${display_name} (Site).<br>
    <br>
    Qualquer pessoa (adiante usuário), que utilize os serviços do ${display_name} deverá ter lido, entendido e aceitado estes Termos e Condições de Uso do Marketplace, os Termos e Condições de Uso Gerais do Site, bem Política de Privacidade do ${display_name} e demais políticas do Site.<br>
    <br>
    1. Objeto<br>
    ...
    <br>
    1.2. O ${display_name} autoriza os usuários Vendedores a anunciarem seus produtos e serviços diretamente no Site, desde que respeitados os termos e condições deste Contrato.<br>
    <br>
    2. Obrigações do Usuário Vendedor<br>
    2.1. Será de exclusiva responsabilidade do usuário Vendedor estabelecer diretamente as características, o preço, a forma de entrega e as demais condições de sua oferta, sem interferência do ${display_name}.<br>
    <br>
    ...
    Leis de Entrega;<br>
    Termos e Condições Gerais de Uso do ${display_name};<br>
    Política de entrega, troca e devolução de produtos;<br>
    Política de Produtos Proibidos; e<br>
    Anexos deste Contrato.<br>
    2.4. O usuário Vendedor somente disponibilizará produtos e/ou serviços que estejam sob seu controle. O usuário Vendedor autoriza, desde já, o ${display_name} a efetuar todo e qualquer cancelamento de compra e devolução dos devidos recursos ao usuário Comprador sempre que por este solicitado, de acordo com a legislação em vigor, ou caso o ${display_name} identifique, a seu único e exclusivo critério, risco na operação.<br>
    <br>
    ...
    (i) Integrar sua plataforma eletrônica ao ${display_name}, diretamente ou por meio de integradores, desde que compatíveis com a tecnologia do ${display_name}. A integração deverá manter as ofertas publicadas na plataforma eletronica do ${display_name} sempre atualizadas no prazo máximo de 1 hora, a partir da alteração do conteúdo na plataforma do usuário Vendedor. <br>
    (ii) Garantir que as ofertas do Site tenham, no mínimo, as mesmas condições comerciais oferecidas na plataforma do usuário Vendedor e nos demais portais e sites em que o usuário Vendedor ofereça seus produtos e/ou serviços. Esta condição não se aplica às formas de pagamento oferecidas, que no Site serão definidas a exclusivo critério do ${display_name}; <br>
    (iii) Responsabilizar-se diretamente em relação aos produtos e/ou serviços por ele oferecidos, pelo atendimento pré e pós venda aos usuários Compradores na ferramenta disponibilizada pelo ${display_name}, por telefone e/ou canais eletrônicos, a exemplo, mas não se limitando ao atendimento por e-mail, através de uma equipe contratada e treinada pelo usuário Vendedor para tal fim, respeitadas as condições estabelecidas no presente Contrato; <br>
    ...
    (vi) Cumprir com suas próprias obrigações tributárias em relação aos produtos e/ou serviços por ele oferecidos a usuários Compradores, em cumprimento à legislação em vigor, inclusive em relação à emissão dos respectivos documentos fiscais diretamente aos usuários Compradores, não podendo imputar ao ${display_name} quaisquer ônus em relação ao cumprimento destas obrigações.<br>
    <br>
    ...
    <br>
    2.9. O usuário Vendedor reconhece e declara que não terá acesso ao endereço eletrônico de qualquer usuário Comprador por meio do ${display_name}, mas tão somente a um e-mail mascarado para eventual contato que se faça necessário.<br>
    <br>
    ...
    <br>
    2.11. As Partes acordam que o ${display_name} poderá disponibilizar aos usuários Compradores mecanismos de -rating- ou -ranking- para avaliação da performance dos usuários Vendedores no Marketplace. O sistema de avaliação será feito exclusivamente com informações inseridas pelos usuários Compradores, não tendo o ${display_name} qualquer ingerência e/ou direito de editar os conteúdos publicados, exceto, nos casos de conteúdos de baixo calão e/ou que violem a legislação em vigor.<br>
    <br>
    3. Obrigações do usuário Comprador<br>
    3.1. Para realizar transações no Marketplace do ${display_name}, o usuário Comprador deverá ler, compreender e aceitar expressamente o presente Termo e Condições de Uso do Marketplace, bem como os demais documentos neste relacionados, especialmente o Termos e Condições de Uso Gerais do Site, que contempla a Política de Privacidade e demais anexos.<br>
    <br>
    3.2. O usuário Comprador declara estar ciente das responsabilidades e obrigações dos usuários Vendedores descritas neste Contrato, reconhecendo que ao comprar um produto e/ou serviço diretamente de um usuário Vendedor, o ${display_name} não possuirá qualquer responsabilidade pelo conteúdo, prazo de entrega, atendimento e condições da oferta do usuário Vendedor, cabendo ao ${display_name} apenas promover a aproximação entre os usuários Vendedor e Comprador, por meio da sua plataforma de Marketplace.<br>
    <br>
    3.3. Ao realizar transações no Marketplace do ${display_name}, o usuário Comprador autoriza, expressamente, que o ${display_name} disponibilize seus dados ao usuário Vendedor do qual será adquirido o produto ou serviço pelo usuário Comprador, para que este concretize a transação.<br>
    <br>
    3.4. Os Termos e Condições de Uso do Marketplace do ${display_name} estão sujeitos a constante melhoria e aprimoramento. Assim, o ${display_name} se reserva o direito de modificar a qualquer momento, de forma unilateral, o presente documento. Os novos Termos e Condições de uso do Marketplace entrarão em vigor após 10 (dez) dias contados de sua publicação no Portal. Caso o usuário Comprador não esteja de acordo com as novas regras, deverá entrar em contato com os canais de atendimento do ${display_name}, hipótese em que se considerará rescindido seu vínculo contratual com o ${display_name}, devendo, no entanto, ser cumpridas todas as obrigações assumidas até o momento da efetiva rescisão.<br>
    <br>
    3.5. O usuário Comprador deverá cumprir com suas próprias obrigações tributárias, em cumprimento à legislação em vigor, não podendo imputar ao ${display_name} quaisquer ônus em relação ao cumprimento destas obrigações.<br>
    <br>
    4. Obrigações do ${display_name}<br>
    4.1. O ${display_name} será responsável pelo desenvolvimento do Marketplace, incluindo, mas não se limitando a, toda estrutura física e tecnológica para a manutenção do serviço prestado.<br>
    <br>
    4.1.1. O ${display_name} oferecerá ainda as ferramentas necessárias ao checkout e processo de pagamento (diretamente ou por meio de serviços prestados por terceiros), bem como ferramentas para comunicações via e-mail relacionadas ao status do frete.<br>
    <br>
    4.2. Obriga-se o ${display_name} a: <br>
    ...
    <br>
    4.3. O ${display_name} poderá oferecer atendimento pós-venda básico, com os seguintes serviços: confirmação de pagamento, problemas no pagamento, informações de frete, status do frete, prazo de entrega estabelecido pelo usuário Vendedor.<br>
    <br>
    4.4. Quando o cancelamento da compra for solicitado pelo usuário Comprador através do Marketplace, o ${display_name} deverá endereçar referida solicitação ao respectivo usuário Vendedor para que adote todas as providências necessárias, conforme cláusula 2.4.<br>
    <br>
    ...
    <br>
    5.3. O ${display_name} não poderá assegurar o êxito de qualquer negociação realizada pelo usuário Vendedor.<br>
    <br>
    6. Responsabilidade pela Integração dos Anúncios<br>
    6.1. O usuário Vendedor deverá, para integração no Marketplace do ${display_name}, disponibilizar seus produtos e/ou serviços por meio de plataforma online, mantida diretamente pelo usuário Vendedor ou por serviços oferecidos por empresas especializadas.<br>
    <br>
    ...
    (iii) Anunciar produtos proibidos pelas políticas do ${display_name} constantes neste Contrato e na legislação aplicável ao produto e ou serviços disponibilizado à venda; <br>
    (iv) Agredir, caluniar, injuriar ou difamar outros usuários Vendedores.<br>
    <br>
    7.2. A prática de quaisquer atos descritos acima poderá ser sancionada pelo ${display_name}, com o consequente e imediato cancelamento ou suspensão do usuário Vendedor no Marketplace, sem prejuízo das ações legais cabíveis.<br>
    <br>
    8. Tarifas e Pagamentos<br>
    8.1. O usuário Vendedor pagará ao ${display_name} tarifa pela utilização do serviço de Marketplace correspondente a um percentual sobre a soma do valor do produto e/ou serviço anunciado e o respectivo frete, denominado "Tarifa". O frete será repassado ao usuário Vendedor que contrata diretamente serviços de transporte.<br>
    <br>
    8.2. Os percentuais e peculiaridades que compõem a Tarifa seguem especificados na Proposta Comercial preenchida no Site. O ${display_name} se resguarda ao direito de propor nova Tarifa a qualquer tempo, sendo certo que, caso o usuário Vendedor não concorde com a alteração da Tarifa proposta, poderá se manifestar no prazo de até 5 (cinco) dias a contar do envio da comunicação pelo ${display_name} para rescisão do Contrato. A não manifestação do usuário Vendedor no prazo descrito nesta cláusula será entendida como aceite tácito.<br>
    <br>
    ...
    <br>
    8.10. O ${display_name} diretamente, ou por meio de terceiros definidos a seu exclusivo critério, poderá oferecer serviços de gerenciamento de pagamento ao usuário Vendedor para pagamento de seus produtos e/ou serviços, podendo ser cobradas tarifas pela utilização de referido serviço.<br>
    <br>
    ...
    <br>
    9.2. O ${display_name} é o único responsável pelos danos causados a seus usuários por defeitos ou vícios relativos exclusivamente à prestação do serviço de Marketplace no site ${website}, desde que o ${display_name} tenha dado causa aos referidos defeitos ou vícios.<br>
    <br>
    9.3. O usuário Vendedor concorda em manter indene o ${display_name}, seus diretores, gerentes, empregados e agentes em relação a todas e quaisquer responsabilidades, obrigações, perdas, danos, penalidades, ações, decisões, processos, custos, despesas, multas, condenações, incluindo, mas não se limitando, honorários ou desembolsos de qualquer natureza decorrentes dos produtos e serviços oferecidos pelo usuário Vendedor por meio do Marketplace, e/ou pelo descumprimento das demais obrigações deste instrumento.<br>
    <br>
    ...
    <br>
    9.5. As Partes reconhecem que não é de responsabilidade do ${display_name} qualquer dano, prejuízo ou perda sofridos pelo usuário Vendedor em razão de falhas na internet, no sistema ou no servidor utilizado pelo usuário Vendedor decorrentes de condutas de terceiros, vírus ou caso fortuito e/ou força maior.<br>
    <br>
    9.6. O usuário Vendedor declara ser o único e exclusivo responsável pela existência, quantidade, qualidade, estado, integridade ou legitimidade dos produtos por ele ofertados no Marketplace, estando o usuário Comprador ciente e de acordo com o aqui estabelecido. As Partes isentam, portanto, o ${display_name} de toda e qualquer responsabilidade neste sentido.<br>
    <br>
    10. Propriedade Intelectual<br>
    10.1. O usuário Vendedor, direta ou indiretamente, não fará ou autorizará o uso das marcas, logotipos, slogans, imagens, patentes, modelos de utilidade, desenhos industriais, segredos industriais ou outra propriedade intelectual do ${display_name}, suas afiliadas, controladas, controladoras e demais empresas do seu grupo econômico ("Propriedade Intelectual"), salvo se necessário para a execução do presente Contrato e exclusivamente durante sua vigência, desde que mediante prévia autorização por escrito do ${display_name}.<br>
    <br>
    10.2. O ${display_name} é titular do Portal ${website} e detém todos os direitos sobre a aparência, design, funcionalidade e todos os demais aspectos do Portal, sendo que tais direitos não poderão ser utilizados, reproduzidos e/ou copiados sem a expressa autorização do ${display_name}.<br>
    <br>
    10.3. O usuário Vendedor declara que as marcas, nomes empresariais título de freteiro, expressão de propaganda, slogans, imagens ou qualquer outra propriedade intelectual por ele e/ou empresas do mesmo grupo econômico utilizadas para a sua própria identificação, não infringem quaisquer direitos de propriedade intelectual de terceiros. Ainda, declara que seus produtos e/ou serviços expostos à venda no portal ${website} não violam ou infringem patente, direito autoral, marca, nome comercial, trade dress, imagem, desenho industrial, segredo comercial ou, sem limitação, quaisquer direitos de propriedade intelectual de terceiros, declarando o usuário Vendedor, por fim, que o presente Contrato não viola quaisquer cessões, licenças ou concessões outorgadas e firmadas entre si e terceiros.<br>
    <br>
    10.4. O usuário Vendedor concorda em manter indene o ${display_name}, seus diretores, gerentes, empregados e agentes em relação a todas e quaisquer responsabilidades, obrigações, perdas, danos, penalidades, ações, decisões, processos, custos, despesas, multas, condenações, incluindo, mas não se limitando, honorários ou desembolsos de qualquer natureza decorrentes de quaisquer violações e/ou alegações de violação de direito autoral e/ou de propriedade industrial de terceiros durante ou após a vigência do presente Contrato.<br>
    <br>
    10.5. O usuário Vendedor, em relação ao conteúdo publicado no site do ${website}, concede ao ${display_name} uma licença gratuita, não exclusiva, livre de royalties, pelo prazo de 10 (dez) anos após o término ou rescisão deste Contrato, para incluindo, mas não se limitando, publicar, reproduzir, distribuir, utilizar, transmitir, exibir, criar trabalhos derivados e de qualquer forma explorar comercialmente todo o conteúdo relativo aos produtos e/ou serviços disponibilizados por meio do Marketplace, incluindo propagandas e marketing promocional por meio do ${display_name}, sites de terceiros, e-mail e outras mídias.<br>
    <br>
    10.6. O usuário Vendedor concede ao ${display_name} licença gratuita e não exclusiva, livre royalties, durante o período de vigência do Contrato para publicação, utilização, reprodução, distribuição, transmissão e exibição das marcas e nome comercial do usuário Vendedor em relação à execução deste Contrato.<br>
    <br>
    10.7. O ${display_name} poderá remover anúncio do usuário Vendedor caso receba alguma denúncia, reclamação ou questionamento de terceiros titular de marca.<br>
    <br>
    ...
    <br>
    11.4. Na hipótese de término deste Contrato por qualquer razão, todos os documentos, dados ou materiais referentes ao ${display_name} em poder do usuário Vendedor ou de seus subcontratados, deverão ser imediatamente devolvidos ao ${display_name}, mediante protocolo de entrega, no endereço constante no preâmbulo deste Contrato.<br>
    <br>
    ...
    13.1. - Reclamações recebidas pelo ${display_name}<br>
    <br>
    13.1.1. É facultado ao ${display_name} intervir no atendimento das reclamações dos usuários Compradores do Marketplace, especialmente nos seguintes casos: (i) o usuário Comprador não recebe o produto e/ou serviço adquirido do usuário Vendedor no prazo ofertado; (ii) o produto e/ou serviço recebido é diferente do descrito na página do produto e/ou serviço; (iii) o produto e/ou serviço recebido apresenta vício ou defeito; e/ou (iv) o usuário Comprador deseja devolver o produto e não é atendido pelo usuário Vendedor. Nestas hipóteses, entre outras, o ${display_name} mediará a solução do problema entre os usuários Comprador e Vendedor, seguidos os procedimentos descritos nesta cláusula.<br>
    <br>
    13.1.2. Recebida a reclamação do usuário Comprador, o ${display_name} encaminhará a ocorrência ao usuário Vendedor, que deverá apresentar solução definitiva ao usuário Comprador, sempre no prazo de 5 (cinco) dias úteis (contados do envio da reclamação pelo ${display_name}).<br>
    <br>
    13.1.3. Findo o prazo para solução da ocorrência sem resposta ou solução por parte do usuário Vendedor, a equipe de atendimento do ${display_name} poderá optar pelo cancelamento da transação e o ressarcimento integral dos valores pagos ao usuário Comprador.<br>
    <br>
    13.2. - Reclamações recebidas diretamente pelo usuário Vendedor<br>
    <br>
    13.2.1. Caso a reclamação seja feita pelo usuário Comprador diretamente junto ao usuário Vendedor, o usuário Vendedor deverá notificar o ${display_name} sobre os casos de cancelamento do frete nos seguintes prazos:<br>
    <br>
    Motivo do Cancelamento	Prazo para notificação do ${display_name}<br>
    ...
    13.2.2. Caso chegue ao conhecimento do ${display_name} que a reclamação de um usuário Comprador não foi comunicada pelo usuário Vendedor nos prazos descritos nesta cláusula, poderá o ${display_name} proceder imediatamente ao cancelamento da transação e o ressarcimento integral dos valores pagos ao usuário Comprador.<br>
    <br>
    ...
    <br>
    13.3.3. Nos casos de cancelamento do frete pelo usuário Comprador, especialmente decorrente de falhas ocasionadas pelo usuário Vendedor, serão normalmente cobradas pelo ${display_name} as tarifas por utilização do serviço de Marketplace.<br>
    <br>
    13.3.4. O ${display_name} cobrará do usuário Vendedor, através de descontos em faturas vincendas, todas as tarifas devidas pela prestação dos serviços de Marketplace, bem como todo e qualquer custo comprovadamente arcado pelo ${display_name} com o cancelamento/ressarcimento do usuário Comprador.<br>
    <br>
    ...
    <br>
    14.8. É vedado ao usuário Vendedor representar o ${display_name}, assim como atuar em seu nome ou benefício perante terceiros e/ou Órgão do Governo, em qualquer nível, sem prévia e expressa autorização do ${display_name}.<br>
    <br>
    14.9. As Partes se obrigam por si, seus herdeiros e/ou sucessores ao fiel cumprimento do aqui estipulado. Os direitos aqui previstos não poderão ser cedidos sem o consentimento prévio e por escrito da outra Parte, com exceção da cessão de direitos e obrigações a empresas de mesmo grupo econômico do ${display_name}.<br>
    <br>
    ...
    <br>
    14.17. Sem prejuízo de outras medidas cabíveis, o ${display_name} poderá advertir, suspender, temporária ou definitivamente o usuário Vendedor no Marketplace, cancelar os seus anúncios, iniciando ações legais cabíveis e/ou suspendendo a prestação de seus serviços se: (i) O usuário Vendedor não cumprir qualquer dispositivo destes Termos e Condições de Uso do Marketplace e demais políticas do ${display_name}; (ii) O usuário Vendedor descumprir com seus deveres; (iii) O usuário Vendedor praticar atos fraudulentos ou dolosos; (iv) Caso qualquer informação fornecida pelo usuário Vendedor esteja incorreta; e,(v) Caso o ${display_name} entenda que os anúncios ou qualquer atitude do usuário Vendedor tenha causado algum dano a terceiros ou ao próprio ${display_name} ou, ainda, que possa causar. Nos casos de suspensão do usuário Vendedor, todos os anúncios ativos e/ou ofertas realizadas serão automaticamente cancelados.<br>
    <br>
    14.18. Os Termos e Condições de Uso do Marketplace estão sujeitos a constante melhoria e aprimoramento. Assim, o ${display_name} se reserva o direito de modificar a qualquer momento, de forma unilateral, o presente Termos e Condições de Uso. Os novos Termos e Condições de Uso entrarão em vigor após 10 (dez) dias contados de sua publicação no Site. Caso os usuários Vendedores e usuários Compradores não estejam de acordo com as novas regras, deverão entrar em contato com os canais de atendimento do ${display_name}, hipótese em que se considerará rescindido seu vínculo contratual com o ${display_name}, devendo, no entanto, ser cumpridas todas as obrigações assumidas até o momento da efetiva rescisão. Não havendo manifestação no prazo estipulado, será entendido como aceito os novos Termos e Condições de Uso do Marketplace e o Contrato continuará vinculando as Partes.<br>
    <br>

...
// For local execution, we use the development environment
// Only switching the address vars in order to use the local ones

// BEWARE: Be extra careful when exposing environment vars to the client side. Expose only the extrictly mandatory.
const client = {
    IS_DEVELOPMENT: true,
    SERVER_ADDRESS: `http://localhost:3000`,
    SOCKET_SERVER_ADDRESS: `http://localhost:5000`,
    ...
    GOOGLE_CLIENT_ID: "",
    // Payment Services
    PAGSEGURO_ADDRESS: "https://ws.sandbox.pagseguro.uol.com.br/v2",
};

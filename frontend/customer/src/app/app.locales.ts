...
export class AppLocales {
      ...
      private pt: any = {
            "a_customer": `Quero pedir fretes`,
            "a_merchant": `Sou um freteiro`,
            "about": `Sobre`,
            "about_text": `Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam varius ante eu commodo interdum. Nullam elementum eu mi nec luctus. <br/> 
Sed at turpis sapien. Aenean metus enim, hendrerit vitae eleifend at, posuere sit amet velit. Nulla eu volutpat mi, eu tempus erat.`,
            "accept": `Aceitar`,
            ...
            "add_new_ride_stop": `Adicionar parada (opcional)`,
            "add_ride_destination": `Adicionar destino`,
            ...
            "and_for_the_establishment": `E para o freteiro?`,
            ...
            "BathAndShearAtFreteiro": `Banho e tosa na Freteiro`,
            "BathAtHome": `Banho em Casa`,
            "BathAtFreteiro": `Banho na Freteiro`,
            "bids": `Propostas `,
            "bid_value_placeholder": `Valor da sua proposta (ex.: R$125,00) `,
            "bid_until": `Propostas até `,
            "by": `Por`,
            "cancel": `Cancelar`,
            ...
            "congrats": `Parabéns!`,
            "congrats_in_order_to_access_the_app_add_the_payment_info": `Parabéns! Seu cadastro foi concluído com sucesso! <br> Para liberar o seu acesso ao aplicativo, por favor, insira as informações para o pagamento das mensalidades abaixo :)`,
    ...
    <br>para o seu Pet!`,
            ...
            "error_minimum_value_is_greater_than_order_total": `Ops! O valor do seu frete é menor do que o valor mínimo para fretes definido pelo freteiro. <br> Aproveite esta chance para obter outros produtos e evitar imprevistos ;)`,
...
Verifique a conexão do seu dispositivo e tente novamente ;)`,
            "establishment": `Sou uma Freteiro`,
            "establishment_description": `Uma breve descrição sobre o seu negócio`,
            "evaluate": `Avaliar`,
            "evaluation": `Avaliação`,
            "exit": `Sair`,
            "failed_saving_picture_for_item": `Ops! Houve uma falha salvando uma das imagens. Por favor, tente novamente.`,
            "female": `Feminino`,
            "finish_order": `Finalizar frete`,
            ...
            "for_the_establishment": `Para o freteiro`,
            ...
            "hello": `Olá`,
            "please_input_your_data_below": `Pronto para começar? <br> Por favor, insira seus dados abaixo:`,
            ...
            "ingredient_quantity": `Quantidade`,
            "ingredient_quantity_example": `200mg`,
            ...
            "item_description_example": ``,
            "item_image": `Imagem`,
            "item_name": `Nome do item`,
            "item_name_example": `Exemplo: Açúcar Mascavo Bellavista 50mg`,
            ...
            "last_step": `Fim`,
            "latest_recipes": `Últimas receitas`,
            ...
            "loading_merchants": `Carregando freteiros`,
            "loading_order_history": `Carregando histórico...`,
            "loading_orders": `Carregando fretes`,
            ...
            "M": `Médio (M)`,
            "male": `Masculino`,
            "post_a_bid": `Fazer proposta`,
            "powered_by": `Feito com <span style="color: red;">❤</span> por Efforia Labs`,
            "map": `Mapa`,
            ...
            "meet_the_project": `Conheça a Frete Fácil!`,
            "merchant": `Freteiro`,
            "merchants": `Freteiros`,
    ...
    <br> para você e para o seu negócio!`,
            ...
            "merchant_choosen_successfully": `Freteiro escolhido com sucesso! Assim que o frete tiver início, você poderá ver a sua localização nesta tela ;)`,
            ...
            "no": `Não`,
            "no_bids_yet": `Este frete ainda não possui nenhuma proposta. Veja que ótima oportunidade de ser o primeiro! ;)`,
            ...
            "no_items_on_service_message": `Olá! Adicione itens ao seu frete clicando no botão abaixo ;)`,
            ...
            "no_jobs_around_message": `Ops! Não há nenhum frete próximo a você no momento. Volte mais tarde para verificar se um novo frete foi realizado ;)`,
            "no_merchant_found_message": `Nenhum freteiro foi encontrado na sua região :( <br/> <a href="mailto:ola@petmarket.io">Entre em contato</a>, nos avise do seu interesse para que possamos fazer uma experiência mais completa para você!`,
            "no_merchant_bids_yet": `Ops! Este frete ainda não possui nenhuma proposta. Assim que alguma proposta for feita, ela será exibida aqui ;)`,
            "no_orders_made_message": `Ops! Você ainda não possui nenhum frete realizado.
 <br/> Assim que seu primeiro frete for criado, ele aparecerá aqui ;)`,
            "no_orders_on_this_period": `Ops! Não há nenhum frete a ser exibido. Selecione outro período, ou aguarde novos fretes serem feitos ;)`,
            "no_orders_yet": `Olá! Você ainda não recebeu nenhum frete. Lembre de ficar de olho nesta aba para não perder nada ;)`,
            ...
            "no_pending_orders": `Oba! Você não possui nenhum frete pendente. Fique de olho: Assim que você recebê-los, eles serão exibidos aqui ;)`,
...
<br/> Acesse a aba de Produtos para adicioná-los ;)`,
 ...
 <br/> Adicione produtos ao estoque e clique no "+" para criá-la ;)`,
            ...
            "order": `Frete`,
            "order_accepted_successfully": `Frete aceito com sucesso!`,
            "order_canceled_successfully": `Frete cancelado com sucesso!`,
            "order_history": `Fretes`,
            "order_details": `Detalhes do Frete`,
            "order_status_awaiting_for_bids": `Aguardando propostas`,
            "order_status_created": `Aguardando propostas`,
            "order_status_awaiting_for_confirmation": `Aguardando confirmação`,
            "order_status_confirmed": `Confirmado`,
            "order_status_started": `Em andamento`,
            "order_status_rejected": `Frete rejeitado. Selecione um novo freteiro.`,
...
Insira seu e-mail abaixo para recuperá-la:`,
            ...
            "payment_modes": `Métodos de pagamento`,
            ...
            "products": `Produtos`,
            "profile": `Perfil`,
            "project_name": `Frete Fácil`,
            "project_slogan": `Você ama pets? Então vem com a gente!`,
            "promotion": `Promoção`,
            ...
            "search_by_the_partner_name": `Pesquise pelo nome do freteiros ;)`,
            "select": `Selecionar`,
            "select_picture": `Selecionar`,
            "select_a_bank_account": `Selecione uma conta abaixo`,
            "selling": `Vendas`,
            "SENIOR": `Sênior`,
            "show_destination": `Mostrar destino`,
            "senior": `Sênior`,
            ...
            "start_ride": `Iniciar frete`,
            "status": `Status`,
            "steps": `Etapas`,
            "stop": `Parada`,
            "stop_address": `Endereço da parada (Ex.: Av. Copacabana, 2332)`,
            "stop_initial": `Partida`,
            "stop_items": `Itens da parada`,
            "stop_item_example": `Ex: 1 Freezer`,
            "stop_final": `Destino`,
            "stop_optional": `Parada (Opcional)`,
    ...
    <br>
    Para que você possa utilizar o Marketplace do Frete Fácil destacamos algumas informações da contratação do serviço e outros temas relevantes para facilitar a sua experiência no nosso Site:<br>
    <br>
    A - O que é o Marketplace do Frete Fácil? Marketplace nada mais é do que um grande local de compras e vendas de produtos. No ambiente online isso se traduz em um espaço virtual onde além de serem vendidos produtos e serviços pelo Frete Fácil, a empresa permite que outros lojistas anunciem seus produtos e serviços através do endereço eletrônico www.fretefacil.efforia.io. Assim, o Frete Fácil é mais do que uma loja virtual, é como se fosse um shopping center virtual, onde vários lojistas vendem seus produtos e serviços diretamente aos consumidores. Podemos dizer então que o Frete Fácil é uma plataforma online, integrada ao portal www.fretefacil.efforia.io, onde um usuário Vendedor pode oferecer seus próprios produtos e/ou serviços diretamente a usuários Compradores. O serviço prestado pelo Frete Fácil é o oferecimento desta plataforma aos usuários, com inúmeras funcionalidades, permitindo que usuários Vendedores e Compradores se aproximem e realizem transações diretamente entre si.<br>
    <br>
    B - Quem vende os produtos ou serviços do Marketplace? Ao acessar o endereço www.fretefacil.efforia.io e buscar um produto e/ou serviço, o usuário Comprador terá várias ofertas relacionadas ao produto e/ou serviços que procura. Essas ofertas podem ser de produto vendido e entregue diretamente pelo Frete Fácil ou vendido e entregue diretamente por um usuário Vendedor. Atenção: quando você, usuário Comprador, escolher um produto ou serviço oferecido diretamente por terceiros, usuários Vendedores, você estará sujeito às regras e condições de oferta disponibilizada por este usuário Vendedor. O Frete Fácil não regula preço, prazo de entrega e condições da oferta, sendo estas feitas exclusivamente pelo usuário Vendedor. Desta forma, o usuário Comprador está ciente e de acordo que, ao comprar um produto e/ou serviço diretamente de um usuário Vendedor, o Frete Fácil não será responsável pelo conteúdo, prazo de entrega e condições da oferta do usuário Vendedor. O Frete Fácil somente se responsabiliza pelo seu próprio conteúdo e pelas suas ofertas.<br>
    <br>
    C - Como identifico um produto ou serviço oferecido no Marketplace do Frete Fácil? Em cada oferta do Site é exibida informação sobre quem vende e entrega o produto ou serviço. Antes de adicionar um produto ou serviço no seu carrinho, verifique no campo "Vendido e entregue por" se quem o oferece é um usuário Vendedor ou o Frete Fácil. Abaixo, exemplo de como você visualizará as opções de compra:<br>
    <br>
    ...
    <br>
    E - A quem se aplicam as condições dos Termos e Condições de Uso do Marketplace? Estes Termos e Condições de Uso do Marketplace se aplicam a todos os usuários do Site Vendedores ou Compradores. Ao utilizar o Marketplace do Frete Fácil o usuário declara que leu, compreendeu e aceitou estes Termos e Condições de Uso do Marketplace, os Termos e Condições Gerais de Uso do site, a Política de Privacidade do Frete Fácil e as demais políticas do site.<br>
    <br>
    F - Como esclareço minhas dúvidas sobre o Marketplace do Frete Fácil? Qualquer dúvida sobre o Marketplace do Frete Fácil pode ser esclarecida entrando em contato com nosso Atendimento, por email, chat ou telefone.<br>
    <br>
    Termos e Condições de Uso do Marketplace - Contrato do Usuário<br>
    Estes Termos e Condições de Uso do Marketplace (ou Contrato) aplicam-se aos usuários Vendedores e Compradores dos serviços oferecidos pela Frete Fácil por meio do Site www.Frete Fácil (Site).<br>
    <br>
    Qualquer pessoa (adiante usuário), que utilize os serviços do Frete Fácil deverá ter lido, entendido e aceitado estes Termos e Condições de Uso do Marketplace, os Termos e Condições de Uso Gerais do Site, bem Política de Privacidade do Frete Fácil e demais políticas do Site.<br>
    <br>
    1. Objeto<br>
    ...
    <br>
    1.2. O Frete Fácil autoriza os usuários Vendedores a anunciarem seus produtos e serviços diretamente no Site, desde que respeitados os termos e condições deste Contrato.<br>
    <br>
    2. Obrigações do Usuário Vendedor<br>
    2.1. Será de exclusiva responsabilidade do usuário Vendedor estabelecer diretamente as características, o preço, a forma de entrega e as demais condições de sua oferta, sem interferência do Frete Fácil.<br>
    <br>
    ...
    Leis de Entrega;<br>
    Termos e Condições Gerais de Uso do Frete Fácil;<br>
    Política de entrega, troca e devolução de produtos;<br>
    Política de Produtos Proibidos; e<br>
    Anexos deste Contrato.<br>
    2.4. O usuário Vendedor somente disponibilizará produtos e/ou serviços que estejam sob seu controle. O usuário Vendedor autoriza, desde já, o Frete Fácil a efetuar todo e qualquer cancelamento de compra e devolução dos devidos recursos ao usuário Comprador sempre que por este solicitado, de acordo com a legislação em vigor, ou caso o Frete Fácil identifique, a seu único e exclusivo critério, risco na operação.<br>
    <br>
    ...
    (i) Integrar sua plataforma eletrônica ao Frete Fácil, diretamente ou por meio de integradores, desde que compatíveis com a tecnologia do Frete Fácil. A integração deverá manter as ofertas publicadas na plataforma eletronica do Frete Fácil sempre atualizadas no prazo máximo de 1 hora, a partir da alteração do conteúdo na plataforma do usuário Vendedor. <br>
    (ii) Garantir que as ofertas do Site tenham, no mínimo, as mesmas condições comerciais oferecidas na plataforma do usuário Vendedor e nos demais portais e sites em que o usuário Vendedor ofereça seus produtos e/ou serviços. Esta condição não se aplica às formas de pagamento oferecidas, que no Site serão definidas a exclusivo critério do Frete Fácil; <br>
    (iii) Responsabilizar-se diretamente em relação aos produtos e/ou serviços por ele oferecidos, pelo atendimento pré e pós venda aos usuários Compradores na ferramenta disponibilizada pelo Frete Fácil, por telefone e/ou canais eletrônicos, a exemplo, mas não se limitando ao atendimento por e-mail, através de uma equipe contratada e treinada pelo usuário Vendedor para tal fim, respeitadas as condições estabelecidas no presente Contrato; <br>
    ...
    (vi) Cumprir com suas próprias obrigações tributárias em relação aos produtos e/ou serviços por ele oferecidos a usuários Compradores, em cumprimento à legislação em vigor, inclusive em relação à emissão dos respectivos documentos fiscais diretamente aos usuários Compradores, não podendo imputar ao Frete Fácil quaisquer ônus em relação ao cumprimento destas obrigações.<br>
    <br>
    ...
    <br>
    2.9. O usuário Vendedor reconhece e declara que não terá acesso ao endereço eletrônico de qualquer usuário Comprador por meio do Frete Fácil, mas tão somente a um e-mail mascarado para eventual contato que se faça necessário.<br>
    <br>
    ...
    <br>
    2.11. As Partes acordam que o Frete Fácil poderá disponibilizar aos usuários Compradores mecanismos de -rating- ou -ranking- para avaliação da performance dos usuários Vendedores no Marketplace. O sistema de avaliação será feito exclusivamente com informações inseridas pelos usuários Compradores, não tendo o Frete Fácil qualquer ingerência e/ou direito de editar os conteúdos publicados, exceto, nos casos de conteúdos de baixo calão e/ou que violem a legislação em vigor.<br>
    <br>
    3. Obrigações do usuário Comprador<br>
    3.1. Para realizar transações no Marketplace do Frete Fácil, o usuário Comprador deverá ler, compreender e aceitar expressamente o presente Termo e Condições de Uso do Marketplace, bem como os demais documentos neste relacionados, especialmente o Termos e Condições de Uso Gerais do Site, que contempla a Política de Privacidade e demais anexos.<br>
    <br>
    3.2. O usuário Comprador declara estar ciente das responsabilidades e obrigações dos usuários Vendedores descritas neste Contrato, reconhecendo que ao comprar um produto e/ou serviço diretamente de um usuário Vendedor, o Frete Fácil não possuirá qualquer responsabilidade pelo conteúdo, prazo de entrega, atendimento e condições da oferta do usuário Vendedor, cabendo ao Frete Fácil apenas promover a aproximação entre os usuários Vendedor e Comprador, por meio da sua plataforma de Marketplace.<br>
    <br>
    3.3. Ao realizar transações no Marketplace do Frete Fácil, o usuário Comprador autoriza, expressamente, que o Frete Fácil disponibilize seus dados ao usuário Vendedor do qual será adquirido o produto ou serviço pelo usuário Comprador, para que este concretize a transação.<br>
    <br>
    3.4. Os Termos e Condições de Uso do Marketplace do Frete Fácil estão sujeitos a constante melhoria e aprimoramento. Assim, o Frete Fácil se reserva o direito de modificar a qualquer momento, de forma unilateral, o presente documento. Os novos Termos e Condições de uso do Marketplace entrarão em vigor após 10 (dez) dias contados de sua publicação no Portal. Caso o usuário Comprador não esteja de acordo com as novas regras, deverá entrar em contato com os canais de atendimento do Frete Fácil, hipótese em que se considerará rescindido seu vínculo contratual com o Frete Fácil, devendo, no entanto, ser cumpridas todas as obrigações assumidas até o momento da efetiva rescisão.<br>
    <br>
    3.5. O usuário Comprador deverá cumprir com suas próprias obrigações tributárias, em cumprimento à legislação em vigor, não podendo imputar ao Frete Fácil quaisquer ônus em relação ao cumprimento destas obrigações.<br>
    <br>
    4. Obrigações do Frete Fácil<br>
    4.1. O Frete Fácil será responsável pelo desenvolvimento do Marketplace, incluindo, mas não se limitando a, toda estrutura física e tecnológica para a manutenção do serviço prestado.<br>
    <br>
    4.1.1. O Frete Fácil oferecerá ainda as ferramentas necessárias ao checkout e processo de pagamento (diretamente ou por meio de serviços prestados por terceiros), bem como ferramentas para comunicações via e-mail relacionadas ao status do frete.<br>
    <br>
    4.2. Obriga-se o Frete Fácil a: <br>
    ...
    <br>
    4.3. O Frete Fácil poderá oferecer atendimento pós-venda básico, com os seguintes serviços: confirmação de pagamento, problemas no pagamento, informações de frete, status do frete, prazo de entrega estabelecido pelo usuário Vendedor.<br>
    <br>
    4.4. Quando o cancelamento da compra for solicitado pelo usuário Comprador através do Marketplace, o Frete Fácil deverá endereçar referida solicitação ao respectivo usuário Vendedor para que adote todas as providências necessárias, conforme cláusula 2.4.<br>
    <br>
    ...
    <br>
    5.3. O Frete Fácil não poderá assegurar o êxito de qualquer negociação realizada pelo usuário Vendedor.<br>
    <br>
    6. Responsabilidade pela Integração dos Anúncios<br>
    6.1. O usuário Vendedor deverá, para integração no Marketplace do Frete Fácil, disponibilizar seus produtos e/ou serviços por meio de plataforma online, mantida diretamente pelo usuário Vendedor ou por serviços oferecidos por empresas especializadas.<br>
    <br>
    ...
    (iii) Anunciar produtos proibidos pelas políticas do Frete Fácil constantes neste Contrato e na legislação aplicável ao produto e ou serviços disponibilizado à venda; <br>
    (iv) Agredir, caluniar, injuriar ou difamar outros usuários Vendedores.<br>
    <br>
    7.2. A prática de quaisquer atos descritos acima poderá ser sancionada pelo Frete Fácil, com o consequente e imediato cancelamento ou suspensão do usuário Vendedor no Marketplace, sem prejuízo das ações legais cabíveis.<br>
    <br>
    8. Tarifas e Pagamentos<br>
    8.1. O usuário Vendedor pagará ao Frete Fácil tarifa pela utilização do serviço de Marketplace correspondente a um percentual sobre a soma do valor do produto e/ou serviço anunciado e o respectivo frete, denominado "Tarifa". O frete será repassado ao usuário Vendedor que contrata diretamente serviços de transporte.<br>
    <br>
    8.2. Os percentuais e peculiaridades que compõem a Tarifa seguem especificados na Proposta Comercial preenchida no Site. O Frete Fácil se resguarda ao direito de propor nova Tarifa a qualquer tempo, sendo certo que, caso o usuário Vendedor não concorde com a alteração da Tarifa proposta, poderá se manifestar no prazo de até 5 (cinco) dias a contar do envio da comunicação pelo Frete Fácil para rescisão do Contrato. A não manifestação do usuário Vendedor no prazo descrito nesta cláusula será entendida como aceite tácito.<br>
    <br>
    ...
    <br>
    8.10. O Frete Fácil diretamente, ou por meio de terceiros definidos a seu exclusivo critério, poderá oferecer serviços de gerenciamento de pagamento ao usuário Vendedor para pagamento de seus produtos e/ou serviços, podendo ser cobradas tarifas pela utilização de referido serviço.<br>
    <br>
    ...
    <br>
    9.2. O Frete Fácil é o único responsável pelos danos causados a seus usuários por defeitos ou vícios relativos exclusivamente à prestação do serviço de Marketplace no site www.fretefacil.efforia.io, desde que o Frete Fácil tenha dado causa aos referidos defeitos ou vícios.<br>
    <br>
    9.3. O usuário Vendedor concorda em manter indene o Frete Fácil, seus diretores, gerentes, empregados e agentes em relação a todas e quaisquer responsabilidades, obrigações, perdas, danos, penalidades, ações, decisões, processos, custos, despesas, multas, condenações, incluindo, mas não se limitando, honorários ou desembolsos de qualquer natureza decorrentes dos produtos e serviços oferecidos pelo usuário Vendedor por meio do Marketplace, e/ou pelo descumprimento das demais obrigações deste instrumento.<br>
    <br>
    ...
    <br>
    9.5. As Partes reconhecem que não é de responsabilidade do Frete Fácil qualquer dano, prejuízo ou perda sofridos pelo usuário Vendedor em razão de falhas na internet, no sistema ou no servidor utilizado pelo usuário Vendedor decorrentes de condutas de terceiros, vírus ou caso fortuito e/ou força maior.<br>
    <br>
    9.6. O usuário Vendedor declara ser o único e exclusivo responsável pela existência, quantidade, qualidade, estado, integridade ou legitimidade dos produtos por ele ofertados no Marketplace, estando o usuário Comprador ciente e de acordo com o aqui estabelecido. As Partes isentam, portanto, o Frete Fácil de toda e qualquer responsabilidade neste sentido.<br>
    <br>
    10. Propriedade Intelectual<br>
    10.1. O usuário Vendedor, direta ou indiretamente, não fará ou autorizará o uso das marcas, logotipos, slogans, imagens, patentes, modelos de utilidade, desenhos industriais, segredos industriais ou outra propriedade intelectual do Frete Fácil, suas afiliadas, controladas, controladoras e demais empresas do seu grupo econômico ("Propriedade Intelectual"), salvo se necessário para a execução do presente Contrato e exclusivamente durante sua vigência, desde que mediante prévia autorização por escrito do Frete Fácil.<br>
    <br>
    10.2. O Frete Fácil é titular do Portal www.fretefacil.efforia.io e detém todos os direitos sobre a aparência, design, funcionalidade e todos os demais aspectos do Portal, sendo que tais direitos não poderão ser utilizados, reproduzidos e/ou copiados sem a expressa autorização do Frete Fácil.<br>
    <br>
    10.3. O usuário Vendedor declara que as marcas, nomes empresariais título de freteiro, expressão de propaganda, slogans, imagens ou qualquer outra propriedade intelectual por ele e/ou empresas do mesmo grupo econômico utilizadas para a sua própria identificação, não infringem quaisquer direitos de propriedade intelectual de terceiros. Ainda, declara que seus produtos e/ou serviços expostos à venda no portal www.fretefacil.efforia.io não violam ou infringem patente, direito autoral, marca, nome comercial, trade dress, imagem, desenho industrial, segredo comercial ou, sem limitação, quaisquer direitos de propriedade intelectual de terceiros, declarando o usuário Vendedor, por fim, que o presente Contrato não viola quaisquer cessões, licenças ou concessões outorgadas e firmadas entre si e terceiros.<br>
    <br>
    10.4. O usuário Vendedor concorda em manter indene o Frete Fácil, seus diretores, gerentes, empregados e agentes em relação a todas e quaisquer responsabilidades, obrigações, perdas, danos, penalidades, ações, decisões, processos, custos, despesas, multas, condenações, incluindo, mas não se limitando, honorários ou desembolsos de qualquer natureza decorrentes de quaisquer violações e/ou alegações de violação de direito autoral e/ou de propriedade industrial de terceiros durante ou após a vigência do presente Contrato.<br>
    <br>
    10.5. O usuário Vendedor, em relação ao conteúdo publicado no site do www.fretefacil.efforia.io, concede ao Frete Fácil uma licença gratuita, não exclusiva, livre de royalties, pelo prazo de 10 (dez) anos após o término ou rescisão deste Contrato, para incluindo, mas não se limitando, publicar, reproduzir, distribuir, utilizar, transmitir, exibir, criar trabalhos derivados e de qualquer forma explorar comercialmente todo o conteúdo relativo aos produtos e/ou serviços disponibilizados por meio do Marketplace, incluindo propagandas e marketing promocional por meio do Frete Fácil, sites de terceiros, e-mail e outras mídias.<br>
    <br>
    10.6. O usuário Vendedor concede ao Frete Fácil licença gratuita e não exclusiva, livre royalties, durante o período de vigência do Contrato para publicação, utilização, reprodução, distribuição, transmissão e exibição das marcas e nome comercial do usuário Vendedor em relação à execução deste Contrato.<br>
    <br>
    10.7. O Frete Fácil poderá remover anúncio do usuário Vendedor caso receba alguma denúncia, reclamação ou questionamento de terceiros titular de marca.<br>
    <br>
    ...
    <br>
    11.4. Na hipótese de término deste Contrato por qualquer razão, todos os documentos, dados ou materiais referentes ao Frete Fácil em poder do usuário Vendedor ou de seus subcontratados, deverão ser imediatamente devolvidos ao Frete Fácil, mediante protocolo de entrega, no endereço constante no preâmbulo deste Contrato.<br>
    <br>
    ...
    13.1. - Reclamações recebidas pelo Frete Fácil<br>
    <br>
    13.1.1. É facultado ao Frete Fácil intervir no atendimento das reclamações dos usuários Compradores do Marketplace, especialmente nos seguintes casos: (i) o usuário Comprador não recebe o produto e/ou serviço adquirido do usuário Vendedor no prazo ofertado; (ii) o produto e/ou serviço recebido é diferente do descrito na página do produto e/ou serviço; (iii) o produto e/ou serviço recebido apresenta vício ou defeito; e/ou (iv) o usuário Comprador deseja devolver o produto e não é atendido pelo usuário Vendedor. Nestas hipóteses, entre outras, o Frete Fácil mediará a solução do problema entre os usuários Comprador e Vendedor, seguidos os procedimentos descritos nesta cláusula.<br>
    <br>
    13.1.2. Recebida a reclamação do usuário Comprador, o Frete Fácil encaminhará a ocorrência ao usuário Vendedor, que deverá apresentar solução definitiva ao usuário Comprador, sempre no prazo de 5 (cinco) dias úteis (contados do envio da reclamação pelo Frete Fácil).<br>
    <br>
    13.1.3. Findo o prazo para solução da ocorrência sem resposta ou solução por parte do usuário Vendedor, a equipe de atendimento do Frete Fácil poderá optar pelo cancelamento da transação e o ressarcimento integral dos valores pagos ao usuário Comprador.<br>
    <br>
    13.2. - Reclamações recebidas diretamente pelo usuário Vendedor<br>
    <br>
    13.2.1. Caso a reclamação seja feita pelo usuário Comprador diretamente junto ao usuário Vendedor, o usuário Vendedor deverá notificar o Frete Fácil sobre os casos de cancelamento do frete nos seguintes prazos:<br>
    <br>
    Motivo do Cancelamento	Prazo para notificação do Frete Fácil<br>
    ...
    13.2.2. Caso chegue ao conhecimento do Frete Fácil que a reclamação de um usuário Comprador não foi comunicada pelo usuário Vendedor nos prazos descritos nesta cláusula, poderá o Frete Fácil proceder imediatamente ao cancelamento da transação e o ressarcimento integral dos valores pagos ao usuário Comprador.<br>
    <br>
    13.3. Condições Gerais para atendimento ou cancelamento do frete do usuário Comprador<br>
    <br>
    ...
    <br>
    13.3.3. Nos casos de cancelamento do frete pelo usuário Comprador, especialmente decorrente de falhas ocasionadas pelo usuário Vendedor, serão normalmente cobradas pelo Frete Fácil as tarifas por utilização do serviço de Marketplace.<br>
    <br>
    13.3.4. O Frete Fácil cobrará do usuário Vendedor, através de descontos em faturas vincendas, todas as tarifas devidas pela prestação dos serviços de Marketplace, bem como todo e qualquer custo comprovadamente arcado pelo Frete Fácil com o cancelamento/ressarcimento do usuário Comprador.<br>
    <br>
    ...
    <br>
    14.8. É vedado ao usuário Vendedor representar o Frete Fácil, assim como atuar em seu nome ou benefício perante terceiros e/ou Órgão do Governo, em qualquer nível, sem prévia e expressa autorização do Frete Fácil.<br>
    <br>
    14.9. As Partes se obrigam por si, seus herdeiros e/ou sucessores ao fiel cumprimento do aqui estipulado. Os direitos aqui previstos não poderão ser cedidos sem o consentimento prévio e por escrito da outra Parte, com exceção da cessão de direitos e obrigações a empresas de mesmo grupo econômico do Frete Fácil.<br>
    <br>
    ...
    <br>
    14.17. Sem prejuízo de outras medidas cabíveis, o Frete Fácil poderá advertir, suspender, temporária ou definitivamente o usuário Vendedor no Marketplace, cancelar os seus anúncios, iniciando ações legais cabíveis e/ou suspendendo a prestação de seus serviços se: (i) O usuário Vendedor não cumprir qualquer dispositivo destes Termos e Condições de Uso do Marketplace e demais políticas do Frete Fácil; (ii) O usuário Vendedor descumprir com seus deveres; (iii) O usuário Vendedor praticar atos fraudulentos ou dolosos; (iv) Caso qualquer informação fornecida pelo usuário Vendedor esteja incorreta; e,(v) Caso o Frete Fácil entenda que os anúncios ou qualquer atitude do usuário Vendedor tenha causado algum dano a terceiros ou ao próprio Frete Fácil ou, ainda, que possa causar. Nos casos de suspensão do usuário Vendedor, todos os anúncios ativos e/ou ofertas realizadas serão automaticamente cancelados.<br>
    <br>
    14.18. Os Termos e Condições de Uso do Marketplace estão sujeitos a constante melhoria e aprimoramento. Assim, o Frete Fácil se reserva o direito de modificar a qualquer momento, de forma unilateral, o presente Termos e Condições de Uso. Os novos Termos e Condições de Uso entrarão em vigor após 10 (dez) dias contados de sua publicação no Site. Caso os usuários Vendedores e usuários Compradores não estejam de acordo com as novas regras, deverão entrar em contato com os canais de atendimento do Frete Fácil, hipótese em que se considerará rescindido seu vínculo contratual com o Frete Fácil, devendo, no entanto, ser cumpridas todas as obrigações assumidas até o momento da efetiva rescisão. Não havendo manifestação no prazo estipulado, será entendido como aceito os novos Termos e Condições de Uso do Marketplace e o Contrato continuará vinculando as Partes.<br>
    <br>
    ...
    Estes Termos e Condições de Uso do Marketplace são regidos pelas Leis do Brasil. Para todas as controvérsias e questões relacionadas e estes Termos e Condições as partes elegem o foro da Comarca de Porto Alegre - RS. Ficam excluídas desta regra as questões em que o Usuário se enquadre no conceito legal de Consumidor, situação em que qualquer.`,
            ...
            "tuesday": `Terça-feira`,
            "type": `Tipo`,
            "type_your_address_to_search_for_merchants": `Digite o endereço desejado acima para buscar por freteiros próximos a você ;)`,
            ...
            "waiting_for_the_establishment": `Aguardando o freteiro...`,
            "we_need_your_permission_for_geolocation": `Olá! Para garantir uma melhor experiência no aplicativo, nós precisamos de acesso à sua localização. Tudo bem?`,
...
Finalize a compra ou esvazie o carrinho para adicionar produtos de outras lojas.`,
            "you_have_received_a_new_order": `Você recebeu um novo frete!`,
            "you_have_received_a_new_order_message": `Olá! Você recebeu um novo frete de CUSTOMER_NAME`,
            "you_love_pets_but_life_is_a_rush": `Você ama pets, mas a vida anda corrida?`,
            "you_must_be_authenticated_to_finish_the_order": `Ops! Você deve estar autenticado para finalizar o frete ;)`,
            ...
            "your_bid_must_be_lower_than_the_last_one": `Ops! Seu lance deve ter um valor inferior ao último lance feito ;)`,
            ...
            "your_order_has_been_canceled": `Seu frete foi cancelado :(`,
            "your_order_has_been_canceled_message": `Olá, seu frete com MERCHANT_NAME foi cancelado.`,
            "your_order_has_started": `Seu frete teve início!`,
            "your_order_has_started_message": `Olá, MERCHANT_NAME iniciou o seu frete! Confira o progresso do frete no aplicativo ;)`,
            "your_order_has_been_confirmed": `Seu frete foi enviado! Aguarde a confirmação com o melhor preço em seu e-mail ;)`,
            "your_order_has_been_confirmed_message": `Seu frete com MERCHANT_NAME foi confirmado!`,
            ...
            "your_store_name": `Nome da sua loja`,

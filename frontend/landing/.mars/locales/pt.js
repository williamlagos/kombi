...
module.exports = {
    ...
    <br>
    4.1.1. O ${display_name} oferecerá ainda as ferramentas necessárias ao checkout e processo de pagamento (diretamente ou por meio de serviços prestados por terceiros), bem como ferramentas para comunicações via e-mail relacionadas ao status do pedido.<br>
    <br>
    ...
    <br>
    4.3. O ${display_name} poderá oferecer atendimento pós-venda básico, com os seguintes serviços: confirmação de pagamento, problemas no pagamento, informações de pedido, status do pedido, prazo de entrega estabelecido pelo usuário Vendedor.<br>
    <br>
    ...
    <br>
    8.5. Para solicitar um estorno ao ${display_name}, o usuário Vendedor deverá informar da forma definida pelo ${display_name}: (i) Número do pedido; (ii) Item a ser ressarcido; (iii) Valor a ser ressarcido; (iv) Data do pedido; e. (v) Motivo do ressarcimento.<br>
    <br>
    8.6. O ${display_name}, ao processar os pedidos de estorno reterá/cobrará, também a título de tarifa pela utilização do serviço, o equivalente a 5% (cinco por cento) do valor total da compra cancelada. Eventual conciliação financeira será realizada na fatura seguinte ao da realização do estorno.<br>
    <br>
    ...
    <br>
    13.2.1. Caso a reclamação seja feita pelo usuário Comprador diretamente junto ao usuário Vendedor, o usuário Vendedor deverá notificar o ${display_name} sobre os casos de cancelamento do pedido nos seguintes prazos:<br>
    <br>
    ...
    <br>
    13.3.3. Nos casos de cancelamento do pedido pelo usuário Comprador, especialmente decorrente de falhas ocasionadas pelo usuário Vendedor, serão normalmente cobradas pelo ${display_name} as tarifas por utilização do serviço de Marketplace.<br>
    <br>
    ...
    "whoops_you_must_be_logged_in_to_comment": `Ops! Você deve estar logado para comentar ;)`,
    ...
    "your_order_has_been_canceled_message": `Olá, seu pedido para MERCHANT_NAME foi cancelado. Não se preocupe: O pagamento só é debitado de seu cartão quando os pedidos são aceitos com sucesso.`,
    "your_order_has_been_confirmed": `Olá, seu pedido foi confirmado!`,
    "your_order_has_been_confirmed_message": `Seu pedido foi confirmado!`,

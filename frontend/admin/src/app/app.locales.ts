...
export class AppLocales {
    ...
    Aqui estão os contatos da ONG resposável para que vocês possam combinar a adoção ;)`,
            ...
            "choose_your_subscription_plan_below": ` Selecione o plano mais adequado você ;)`,
...
Verifique a conexão do seu dispositivo e tente novamente ;)`,
    ...
    <br> para você e para o seu negócio!`,
            ...
            "no_merchant_found_message": `Nenhum estabelecimento foi encontrado na sua região :( <br/> <a href="mailto:ola@99pets.org">Entre em contato</a>, nos avise do seu interesse para que possamos fazer uma experiência mais completa para você!`,
 ...
 <br/> Finalize uma compra para visualizá-los aqui ;)`,
            ...
            "no_pets_found_message": `Já tem um ou mais pets? Cadastre eles  na plataforma para ter mais praticidade ;)`,
...
<br/> Acesse a seção de Estoque para adicioná-los ;)`,
...
Finalize a compra ou esvazie o carrinho para adicionar produtos de outras lojas.`,
            ...
            "your_order_has_been_sent": `Seu pedido foi enviado com sucesso! Aguarde a confirmação no seu-email ;)`,

...
function configureIndexColors() {
    log("configuring index.html...".yellow);
    ...
    index = index.replace(/darker_primary_color_placeholder/g, colors.darker_primary_color);
    index = index.replace(/primary_color_placeholder/g, colors.primary_color);

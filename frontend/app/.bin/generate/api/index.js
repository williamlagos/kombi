...
const server = require("../../../../../backend/server/app");
const swagger = require("../../../../../backend/server/swagger.json");
...
const moduleDir = path.join(__dirname, "../../../../../frontend/app/src/backend"); // Sets the output filename
...
async function generate() {
    ...
    let commonjs = await babel.transform(codeResult, { plugins: ["transform-es2015-modules-commonjs"] }).code; // Adapts the code with babel for compatibilty
